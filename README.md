...
- **Language:** Python (async, typing, packaging)
- **APIs:** FastAPI, REST, auth, rate limits
- **LLM:** OpenAI / Anthropic APIs, embeddings, structured outputs
- **RAG:** chunking, hybrid search, citations
- **Agents:** LangChain, LangGraph, CrewAI, MCP
- **Production:** Docker, queues, observability, cost controls

## Progress tracker

Update this section as you ship milestones.

- [ ] Phase 1 — Python + APIs + Git comfort
- [ ] Phase 2 — LLM fundamentals + small shipped apps
- [ ] Phase 3 — RAG + vector stores
- [ ] Phase 4 — Agents / workflows
- [ ] Phase 5 — Deployed, monitored portfolio pieces
